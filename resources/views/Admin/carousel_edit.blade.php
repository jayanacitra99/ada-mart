          ...
          <div class="row">
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-body">
                    <!-- form start -->
                    <form method="post" action="{{url('admin/carousels/'.$carousel->id)}}" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="form-group col">
                                    ...
                                    <select class="form-control" name="status">
                                      <option value="active" {{$carousel->status == 'active' ? 'select':''}}>Active</option>
                                      <option value="inactive" {{$carousel->status == 'inactive' ? 'select':''}}>Inactive</option>
                                    </select>
                                </div>
                                <div class="form-group col">
                            ...
                            <div class="form-group">
                                <img id="imagePreview" src="{{asset($carousel->image)}}" alt="Image Preview" style="max-width: 200px;">
                            </div>
                            <div class="form-group">
...
<script>
    $(document).ready(function(){
        var startDate = moment("{{Carbon\Carbon::parse($carousel->show_from)->format('Y-m-d H:i')}}");
        var endDate = moment("{{Carbon\Carbon::parse($carousel->show_until)->format('Y-m-d H:i')}}");
